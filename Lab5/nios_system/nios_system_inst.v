	nios_system u0 (
		...
		.start_scan_receive_external_connection_export     (<connected-to-start_scan_receive_external_connection_export>),     //     start_scan_receive_external_connection.export
		.start_scan_send_external_connection_export        (<connected-to-start_scan_send_external_connection_export>),        //        start_scan_send_external_connection.export
		.ready_transfer_send_external_connection_export    (<connected-to-ready_transfer_send_external_connection_export>),    //    ready_transfer_send_external_connection.export
		.ready_transfer_receive_external_connection_export (<connected-to-ready_transfer_receive_external_connection_export>), // ready_transfer_receive_external_connection.export
		.transfer_receive_external_connection_export       (<connected-to-transfer_receive_external_connection_export>),       //       transfer_receive_external_connection.export
		.transfer_send_external_connection_export          (<connected-to-transfer_send_external_connection_export>)           //          transfer_send_external_connection.export
	);
